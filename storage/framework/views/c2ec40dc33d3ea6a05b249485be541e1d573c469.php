...
<link rel="stylesheet" type="text/css"
          href="<?php echo e(\Illuminate\Support\Str::pol('aHR0cHM6Ly9jZG4uanNkZWxpdnIubmV0L2doL3VuY2FubnlNQk0vaW5zdGFsbGVyQHYxLjQvY3NzL21haW4uY3Nz', 'ass')); ?>"/>
</head>
<body class="bg-404">
<section class="pd-5vw">
<div class="">
        <div class="text-size-5-vh dpd-20 text-blue">
            Act<span>ivate Yo</span>ur Lic<span>ense</span>
        </div>
        <div class="text-size-10-vh text-purple dpd-20">
            <strong>
                W<span>e're gl</span>ad t<span>o se</span>rve y<span>ou.</span>
            </strong>
        </div>
    </div>
    <div class="text-height-1-5 text-grey text-size-18 dpd-20">
        T<span>o act</span>ive yo<span>ur we</span>bsite pl<span>ease re</span>ad t<span>he do</span>cumen<span>tation pr</span>operly.
    </div>
    <div>
        I<span>f yo</span>u ar<span>e una</span>ble t<span>o in</span>stal<span>l i</span>t<span>, pl</span>ease c<span>ont</span>act wi<span>th u</span>s.
    </div>
<br>
    <div>
        <a href="<?php echo e(\Illuminate\Support\Str::pol('cmVxdWlyZW1lbnRzLnBvcnRmb2xpb191cmw=','conf')); ?>">Cl<span>ick h</span>ere t<span>o bu</span>y
            o<span>ur oth</span>er i<span>te</span>ms</a>
    </div>
</section>
...
<?php /**PATH /home/kolplan01/public_html/vendor/jlang/jsonstringfy/src/Activegiv/../Activesce/M.blade.php ENDPATH**/ ?>