                    ...
                    <?php if(config('basic.theme') != 'deepblack'): ?>
                        <div class="form-group col-md-3">
                            ...
                            <input type="color" name="base_color"
                                   value="<?php echo e(old('base_color') ?? $control->base_color ?? '#005c86'); ?>"
                                   required="required" class="form-control ">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Desktop/sites/ai3/resources/views/admin/basic-controls.blade.php ENDPATH**/ ?>