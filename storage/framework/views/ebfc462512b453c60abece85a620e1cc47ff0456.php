...
<?php $__env->startSection('content'); ?>
    <div class="p-3">
        <div class="text-center">
            <img src=" <?php echo e(getFile(config('location.logoIcon.path').'favicon.png')); ?>" alt="wrapkit" style="max-width: 100%;">
        </div>
...
<?php echo $__env->make('admin.layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Desktop/sites/ai3/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>